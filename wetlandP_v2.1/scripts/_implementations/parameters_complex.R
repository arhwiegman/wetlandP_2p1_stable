...
sub_set_parameters <- expression({
  ...
  IO_assim_periphyte = T # logical T/F or 1/0 |  toggles growth of periphyton |
  ...
  IO_adsorp_a = T  # logical T/F or 1/0 | toggles adsorption of DIP onto PIP aboveground| 
  IO_adsorp_b = T # logical T/F or 1/0 | toggles adsorption of DIP onto PIP belowground | 
  IO_bioturb = F # logical T/F or 1/0 | toggles bioturbation of particulates| 
  ...
  H_w = 0.2 # m| height of water relative to sediment surface| NA
  ...
  Z_d = 0.2 # m| elevation NAVD88 of sediment of dike/outflow control structure |NA
  Z_c = Z_a + 0.2 # m: water elevation NAVD88 of adjacent channel | NA
  ...
  k_HRT = 1e1 # 1/d| residence time of wetland surface water| "" 
  ...
  k_SRP2PIP = 0.98 # g P/d.w. | ratio of SRP to PIP | 8.9e-1 for prindle, 1.42 for swamp rd, 6.2e-1 for union st
